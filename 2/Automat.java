...
public class Automat {
    ...
    *При заказе от человека учитывать желаемый объем или вес и, для напитков температуру, продуктов.
    ...
    Order createdOrder(ArrayList<Product> listResult){
        ...
        // ЭТО ВСЕ ЧТО СМОГ... УЖЕ ГОЛОВА ДЫМИТСЯ - НЕ ПОНЯТНО ГДЕ ЕГО СОЗДАТЬ ОЧЕНЬ МНОГО ВСЕГО, МНОГО РАЗНЫХ ФАЙЛОВ, МНЕ ПОСЛЕ ДВУХ СЕМИНАРОВ ТЯЖЕЛО В НИХ ОРИЕНТИРОВАТЬСЯ
